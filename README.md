...
|UZH| **EducationAI**  | DSI / Institute of Education & Informatics | Adaptive teaching, feedback automation           | ML-driven prototype tools for personalized instruction | None          | [Link](https://www.dsi.uzh.ch/en/communities/education.html) |
|UZH|**AIdviser: AI-tutor**|Department of Finance | AI chatbot acting as a virtual tutor| Chatbot integrated in KlickerUZH| None | [AIdviser:AI-Tutor](https://www.df.uzh.ch/en/department/teaching-center/projects-and-innovation/aidviser.html)|
|ZHAW| **myScripting**| School of Law and Management | Teacher-support tool for education scripts| Web-based tool for educational design | PHZH | [ZHAW project description](https://www.zhaw.ch/en/research/project/76711#keyData)  [myScripting tool](https://myscripting.sml.zhaw.ch) |
...
| **ZHAW** (CH) | **Seamless Writing / Thesis Writer** (2017–2021, ongoing)          | School of Applied Linguistics – Institute of Language Competence (ILC) & ZID                   | The project seems to be inactive now    | **Thesis Writer** – a web-based platform for guiding thesis writing (supports large numbers of students with digital tutorials); now enhanced with a generative **AI text-quality feedback** tool to assist student writing | Yes – Univ. of Liechtenstein; Univ. of Konstanz; Univ. of St. Gallen; Prognosix AG |[Seamless writer](https://www.zhaw.ch/de/forschung/projekt/71258#:~:text=scientific%20papers,The%20use%20of)
